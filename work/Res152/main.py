...
from paddlevideo.tasks import train_model, train_model_multigrid, test_model, train_dali,val_model
...
def parse_args():
    ...
    parser.add_argument('-t_p',
                        '--t_path',
                        type=str,
                        help='path of test or train npy')
    parser.add_argument('-l_p',
                        '--label_path',
                        type=str,
                        help='path of label npy')
    parser.add_argument('-o_n',
                        '--output_name',
                        type=str,
                        help='output name')
