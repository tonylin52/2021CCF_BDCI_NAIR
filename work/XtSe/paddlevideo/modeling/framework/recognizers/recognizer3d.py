...
class Recognizer3D(BaseRecognizer):
    ...
    def val_step(self, data_batch):
        ...
        # print(confusion_matrix(paddle.squeeze(labels, axis=1), paddle.argmax(cls_score, axis=1)))
    ...
    def test_step(self, data_batch):
        ...
        # call forward
        cls_score = self.forward_net(imgs)
        #print(np.argmax(np.bincount(paddle.argmax(cls_score, axis=1).numpy())))
        #cls_score = cls_score.mean(axis = 0)
        #print(paddle.argmax(cls_score))
